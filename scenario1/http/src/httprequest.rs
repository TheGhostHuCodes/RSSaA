...
impl From<String> for HttpRequest {
    fn from(req: String) -> Self {
        ...
        for line in req.lines() {
            // If the line read is the request line, call function process_req_line().
            if line.contains("HTTP") {
                let (method, resource, version) = process_req_line(line);
                parsed_method = method;
                parsed_version = version;
                parsed_resource = resource;
            // If the line read is a header line, call function process_header_line().
        ...
        // Parse the incoming HTTP request into HttpRequest.
        HttpRequest {
...
fn process_header_line(s: &str) -> (String, String) {
    // Parse the header line into words split by the separator ":"
